...
export class PlayerController {
  ...
  @Post()
  async createPlayer(@Body() data: BodyPostPlayerDto): Promise<ResponseGetPlayerDto> {
    return await this.playerService.createPlayer(data);
  }

  @Get(':id')
  async getSinglePlayer(@Param('id') id: string): Promise<ResponseGetPlayerDto | null> {
    return await this.playerService.getSinglePlayer(id);
  }

  @Put(':id')
  async updatePlayer(@Param('id') id: string, @Body() data: BodyPostPlayerDto): Promise<ResponseGetPlayerDto> {
